  ...
  <Section crosses>
    <div className="container lg:flex">
      ...
      <div className="mt-4 lg:ml-auto xl:w-[38rem]">
        ...
        <div className="relative left-1/2 flex aspect-square w-[22rem] -translate-x-1/2 -translate-y-6 scale-75 rounded-full border border-n-6 md:scale-100">
          ...
          <ul>
            {collabApps.map((app, index) => (
              ...
              >
                <div
                  // eslint-disable-next-line tailwindcss/classnames-order, tailwindcss/no-custom-classname
                  className={`relative top-[-1.6rem] flex size-[3.2rem] rounded-xl border border-n-1/15 bg-n-7 -rotate-${
                    index * 45
                  }`}
                >
                  <img
